package com.lyz.auth.socket.client.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("http://127.0.0.1:7075/")
    ...
    public Docket nettyApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .protocols(PROTOCOL)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.lyz.auth.socket.client.controller"))
